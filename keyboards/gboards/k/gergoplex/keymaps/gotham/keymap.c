...
#define LAYOUT_gergoplex_mods_wrapper(...)       LAYOUT_gergoplex_mods(__VA_ARGS__)

const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {

    [_QWERTY] = LAYOUT_gergoplex_mods_wrapper(
        _________________QWERTY_L1_________________, _________________QWERTY_R1_________________,
        _________________QWERTY_L2_________________, _________________QWERTY_R2_________________,
        _________________QWERTY_L3_________________, _________________QWERTY_R3_________________
    ),
#ifdef ENABLE_LAYOUT_COLEMAK
    [_COLEMAK] = LAYOUT_gergoplex_mods_wrapper(
    ...
    [_COLEMAK_DH] = LAYOUT_gergoplex_mods_wrapper(
    ...
    [_COLEMAK_DHM] = LAYOUT_gergoplex_mods_wrapper(
    ...
    [_DVORAK] = LAYOUT_gergoplex_mods_wrapper(
    ...
    [_WORKMAN] = LAYOUT_gergoplex_mods_wrapper(
    ...
    [_NORMAN] = LAYOUT_gergoplex_mods_wrapper(
